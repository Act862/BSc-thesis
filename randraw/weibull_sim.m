...
channelGain_d = randraw('weibull', [locationParam, shapeParam, scaleParam], sampleSize);
channelGain_e = randraw('weibull', [locationParam, shapeParam, scaleParam], sampleSize);
